...
import { logo, customPause, customerPlay, welcomeVideo } from "../../../assets";
      ...
      <div className="welcomeWrapper">
        <div className="welcomeLeft">
          <div className="welcomeImgWrap">
            <div
              className="playBtnWrapper"
              onClick={isPlaying ? handlePause : handlePlay}
            >
              <img
                src={isPlaying ? customPause : customerPlay}
                className="circleImg"
                alt="Play Button"
              />
            </div>
          ...
          <div className="welcomeLinkWrap">
            {welcomeLinkBtn.map((item, index) => (
              <WelcomeLinkBtn key={index} title={item.title} url={item.path} />
            ))}
          </div>
        </div>
